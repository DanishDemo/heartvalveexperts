    ...
    >
     ...
     {/* Content */}
      <div className="relative max-w-5xl text-center px-4 space-y-6">
        ...
        >
          Specializing in advanced non/minimally invasive procedures for complex valve
          conditions, Heart Valve Experts (HVE) is recognized as Mumbai’s leading
          valve clinic, dedicated to delivering world-class heart care with precision,
