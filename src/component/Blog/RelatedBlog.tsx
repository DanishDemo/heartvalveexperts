...
async function getBlogs(): Promise<BlogPost[]> {
  try {
    const res = await fetch(
      "https://hclient.in/heartvalveexperts/wp-json/custom-api/v1/blogs?fields=title,image,image_alt,slug,date&page=1&per_page=3",
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-10">
          <div className="text-center">
            <p className="text-lg uppercase tracking-wide text-blue-600 text-left font-semibold">
              ● Blogs
            </p>
          ...
          <div>
            <Link href="/blog" className="flex justify-center">
              <button className="flex items-center gap-2 px-5 py-2 border-2 border-gray-900 text-gray-900 rounded-full hover:bg-white hover:text-black transition duration-500 ease-in-out">
